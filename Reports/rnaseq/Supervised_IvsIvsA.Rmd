...
heatmap_200(DE_res$res_df, DE_res$vsd_mat_sym, DE_res$meta_data, DE_res$CDE, scale_mat = T)
```
...
```{r}
# Rename DE_res
DE_res = DE_res_intvsindagg
# Rename fgsea
fgsea_res = fgsea_res_intvsindagg
# title vector
title_label = "Intermediate vs Indolent + Aggressive"
# Vectors for HLA comparisons
cond_colname = "intvs_ind_agg" 
delete_group = FALSE
```
...
```{r}
# Rename DE_res
DE_res = DE_res_aggvsindint
# Rename fgsea
fgsea_res = fgsea_res_aggvsindint
# title vector
title_label = "Aggressive vs Indolent + Intermediate"
# Vectors for HLA comparisons
