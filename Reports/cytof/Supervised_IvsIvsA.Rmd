...
ref <- ref[-which(ref$pt_ID=='11840'),]
prcnt_celltypes <- prcnt_celltypes[-which(rownames(prcnt_celltypes)=='11840'),]
prcnt_clusters <- prcnt_clusters[-which(rownames(prcnt_clusters)=='11840'),]
prcnt_subtypes <- prcnt_subtypes[-which(rownames(prcnt_subtypes)=='11840'),]
...
umap_smp <- umap_smp[-which(umap_smp$pt_ID=='11840'),]
```
...
### Protein-protein correlation (co-expression)
```{r, echo=FALSE, fig.width = 10, fig.height = 8}
nms <- colnames(annot_df)[ft_cols]
protein_corr(co_epi, by_col_names = T, col_names = nms)
```
...
```{r, echo=FALSE, fig.width = 10, fig.height = 8}
nms <- colnames(annot_df)[ft_cols]
protein_corr(co_endo, by_col_names = T, col_names = nms)
```
...
```{r, echo=FALSE, fig.width = 10, fig.height = 8}
nms <- colnames(annot_df)[ft_cols]
protein_corr(co_fmes, by_col_names = T, col_names = nms)
```
...
```{r, echo=FALSE, fig.width = 10, fig.height = 8}
nms <- colnames(annot_df)[ft_cols]
protein_corr(co_tc, by_col_names = T, col_names = nms)
```
...
```{r, echo=FALSE, fig.width = 10, fig.height = 8}
nms <- colnames(annot_df)[ft_cols]
protein_corr(co_th, by_col_names = T, col_names = nms)
```
...
```{r, echo=FALSE, fig.width = 10, fig.height = 8}
nms <- colnames(annot_df)[ft_cols]
protein_corr(co_dnt, by_col_names = T, col_names = nms)
```
...
```{r, echo=FALSE, fig.width = 10, fig.height = 8}
nms <- colnames(annot_df)[ft_cols]
protein_corr(co_mye, by_col_names = T, col_names = nms)
```
...
```{r, echo=FALSE, fig.width = 10, fig.height = 8}
nms <- colnames(annot_df)[ft_cols]
protein_corr(co_oimm, by_col_names = T, col_names = nms)
```
...
```{r, echo=FALSE, fig.width = 15, fig.height = 10}
prcnt_cl_sub_SILA <- prcnt_cl_sub
prcnt_cl_sub_SILA$SILA <- CDE$SILA
corr_plot(prcnt_cl_sub_SILA)
...
```{r echo=FALSE, fig.width = 7, fig.height = 2.2} 
# Scatter plots
ggpubr::ggscatter(log10(prcnt_cl_sub_SILA), x = "ECC_3", y = c('Th_cells', 'Tc_cells', 'Myeloid'),
          add = "reg.line", conf.int = TRUE, combine = TRUE, scales='free',
          cor.coef = TRUE, add.params = list(color = 'grey65'), expand = c(0, 0),
          cor.coeff.args = list(method = "spearman"), 
          xlab = "ECC_3 cells %", ylab = 'Immune cells %') +
...
```{r echo=FALSE, fig.width = 7, fig.height = 2.2} 
# Scatter plots
ggpubr::ggscatter(log10(prcnt_cl_sub_SILA), x = "ECC_5", y = c('Th_cells', 'Tc_cells', 'Myeloid'),
          add = "reg.line", conf.int = TRUE, combine = TRUE, scales='free',
          cor.coef = TRUE, add.params = list(color = 'grey65'), expand = c(0, 0),
          cor.coeff.args = list(method = "spearman"), 
          xlab = "ECC_5 cells %", ylab = 'Immune cells %') +
...
```{r echo=FALSE, fig.width = 7, fig.height = 2.2} 
# Scatter plots
ggpubr::ggscatter(log10(prcnt_cl_sub_SILA), x = "fmes_3", y = c('Th_cells', 'Tc_cells', 'Myeloid'),
          add = "reg.line", conf.int = TRUE, combine = TRUE, scales='free',
          cor.coef = TRUE, add.params = list(color = 'grey65'), expand = c(0, 0),
          cor.coeff.args = list(method = "spearman"), 
          xlab = "fmes_3 cells %", ylab = 'Immune cells %') +
...
```{r echo=FALSE, fig.width = 7, fig.height = 2.2} 
# Scatter plots
ggpubr::ggscatter(log10(prcnt_cl_sub_SILA), x = "OtherI_4", y = c('Th_cells', 'Tc_cells', 'Myeloid'),
          add = "reg.line", conf.int = TRUE, combine = TRUE, scales='free',
          cor.coef = TRUE, add.params = list(color = 'grey65'), expand = c(0, 0),
          cor.coeff.args = list(method = "spearman"), 
          xlab = "OtherI_4 cells %", ylab = 'Immune cells %') +
...
```{r echo=FALSE, fig.width = 7, fig.height = 2.2} 
# Scatter plots
ggpubr::ggscatter(log10(prcnt_cl_sub_SILA), x = "OtherI_2", y = c('Th_cells', 'Tc_cells', 'Myeloid'),
          add = "reg.line", conf.int = TRUE, combine = TRUE, scales='free',
          cor.coef = TRUE, add.params = list(color = 'grey65'), #expand = c(0, 0),
          cor.coeff.args = list(method = "spearman"), 
          xlab = "OtherI_2 cells %", ylab = 'Immune cells %') +
          ggpubr::font("xy.text", size = 10) +
          ggpubr::font("xlab", size = 12, face = 'bold') +
          ggpubr::font("ylab", size = 12, face = 'bold') 
```
...
library(PCAtools)
md <- data.frame('group'=factor(CDE$n_op2, levels = c('ind', 'int', 'agg')))
rownames(md) <- CDE$pt_ID
p <- pca(t(scale(prcnt_cl_sub)), metadata = md, center = F, scale = F)
PCAtools::biplot(p, x='PC1', y='PC2',
                 colkey = c('ind' = '#3498DB', 'int' = 'grey72', 'agg'='#c75264'),
