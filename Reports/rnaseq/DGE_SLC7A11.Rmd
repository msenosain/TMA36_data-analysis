---
title: "Differential gene expression analysis in LUAD patients with high vs low SLC7A11 expression"
...
```{r}
# Load data
load('data/TMA36_project/RNA_Seq/extra/SLC7A11_DE.Rdata')
```
